...
const AnalyticsHead = () => {
  return (
    <div className="flex items-center justify-between bg-gray-500/30 p-2 py-4 pr-20 gap-5 rounded-xl mr-20 special:mx-80 special:px-40 special:text-2xl" style={{ clipPath: 'polygon(95% 0, 100% 33%, 100% 100%, 0 100%, 0 0)' }}>
