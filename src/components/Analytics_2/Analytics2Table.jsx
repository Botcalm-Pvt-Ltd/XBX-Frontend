        ...
        {TABLE_ROWS.map((details, key) => (
          <React.Fragment key={key}>
            <tr className="text-gray-400 text-left group">
              <td className="w-28 text-white/50 group-hover:text-white py-7">{details.date}</td>
              <td className="w-28 text-emerald-500/50 group-hover:text-emerald-500 py-7">
                {details.type}
              </td>
              <td className="w-28 text-emerald-500/50 group-hover:text-emerald-500 py-7">{details.usd}</td>
              <td className="w-28 text-emerald-500/50 group-hover:text-emerald-500 py-7">{details.zuzu}</td>
              <td className="w-28 text-orange-700/50 group-hover:text-orange-700 py-7">{details.weth}</td>
              <td className="w-28 text-orange-700/50 group-hover:text-orange-700 py-7">{details.price}</td>
              <td className="w-28">
