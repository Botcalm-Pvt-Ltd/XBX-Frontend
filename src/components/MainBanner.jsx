...
const MainBanner = () => {
  return (
    <section className="text-white text-center relative py-10 capitalize mx-auto">
      ...
      >
        <h4 className="md:text-xl text-sm font-bold header-font md:tracking-[20px] tracking-widest">
          RAPID ACCESS
        </h4>
      </motion.div>
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <h1 className="xl:text-8xl md:text-5xl text-3xl header-font transform lg:translate-y-14 xl:translate-y-20 translate-y-14 md:translate-y-14  md:tracking-widest">
          <span className="stroke-text">ADVA</span>NCED
        </h1>
      </motion.div>
      <div className="md:w-[800px] 4xl:w-[1000px] w-full mx-auto relative z-[1] px-10 md:px-0 green-gradient">
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <h1 className="xl:text-8xl md:text-5xl text-3xl absolute md:top-24 top-14 left-1/2 transform -translate-x-1/2 header-font md:tracking-widest z-10">
            ANAL<span className="stroke-text">YTICS</span>
          </h1>
        </motion.div>
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <h6 className="md:text-2xl text-md absolute top-1/3 left-1/2 transform -translate-x-1/2 w-full tracking-wider">
            ULTIMATE TOOL FOR ON-CHAIN TRADING
          </h6>
        </motion.div>
        <motion.div
          initial={{ opacity: 0 }}
      ...
      <div className="flex items-end md:flex-row flex-col px-10 xl:-mt-52 lg:-mt-40 md:-mt-20 mt-20 w-fit md:w-full mx-auto">
        <div className="w-72">
          <div className="flex items-start text-sm 4xl:text-2xl md:mb-20 text-left md:text-center">
            <img src={starImage} className="w-3 text-white" />
            <h6>
              <span className="text-gray-400">
                AI adapts to your risk tolerance and{" "}
              </span>
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="w-16 h-16 cursor-pointer">
              <img
                ...
                className="w-full h-full object-contain hover:brightness-150"
              />
            </div>
            <div className="w-16 h-16 cursor-pointer">
              <img
