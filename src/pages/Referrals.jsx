  ...
  return (
    <div>
      <div className="px-10 mr-20 pt-10">
        <div className="flex justify-between special:justify-start gap-0 special:gap-[900px]">
          <ReferralsCard />
          <ReferralsCardcodes />
        </div>
        <div className="relative top-16 special:top-40">
      ...
      <div className="flex justify-center relative top-8 special:top-60">
